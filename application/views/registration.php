                    ...
                    <table>
                        <div id="clientEmail">
                            ...
                            <div class="col-sm-12 form-group">
                                <label for="comment">Email Body:</label>
                                <textarea class="form-control" name="notes" id="client_email_body" rows="15" id="comment">
                                    Dear sir / madam, Greetings From Demo Company... Kindly register the below client For __________________ project On behalf Of Demo Company Property & acknowledge. Client Name : ________________ Contact No. : ________________ E-mail ID : ________________ Thanks & Regards Team Demo Company
                                </textarea>
                            </div>
                            <div class="form-row">
