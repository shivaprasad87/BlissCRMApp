...
class User_model extends CI_Model {
    ...
    public function add_user($data){
        ...
        if((in_array($data['type'], array(1,2))) && ($data['email'])){
            ...
            $this->email->subject("Welcome to Demo Company");
            $this->email->message("Welcome to Demo Company CRM System,<br><br>Your user name is ".$data['emp_code']." And password is ".$data['emp_code']." by using them please login to the tool with the following link: <a href=\"https://google.com/\" >https://google.com/</a> <br><br>Regards Demo Company IT team");
            $this->email->send();
        }
    }
